...
if (function_exists('clwc_add_category_title') === false) {
    ...
    function clwc_add_category_title($args=[])
    {
        ...
        // Returns true if on a WooCommerce page.
		// Except cart, checkout and other standard pages with shortcode.
        if (is_woocommerce()) {
        ...
        if (is_woocommerce()) {
            ...
            if (empty($terms) === false) {
                ...
                foreach ($terms as $term) {
                    echo '<li class="category-listing__item" id="category-listing__item--'.$term->slug.'">';
...
if (function_exists('clwc_add_product_title') === false) {
    ...
    function clwc_add_product_title($args=[])
    {
        ...
        if (is_woocommerce()) {
            ...
            echo '<h2 class="product-listing__heading">';
